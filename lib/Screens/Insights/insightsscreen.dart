        ...
        child: Row(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                // CustomText(
                //   text: '${ordersController.totalcount ?? 0}', // ✅ null safe
                //   style: CustomTextStyle.insNum,
                // ),
                Obx(() => CustomText(
  text: '${ordersController.totalcount.value}',
  style: CustomTextStyle.insNum,
)),
        ...
        child: Row(
          children: [
            ...
            Column(
              ...
              children: [
                // CustomText(
                //   text: '${(ordersController.totalearnings).toStringAsFixed(2)}', // ✅ safe format
                //   style: CustomTextStyle.insNum,
                // ),
                Obx(() => CustomText(
  text: ordersController.totalearnings.value.toStringAsFixed(2),
  style: CustomTextStyle.insNum,
)),
...
int i = 0; // Do not change this
Widget buildOrderCard(BuildContext context, Map<String, dynamic> order, int index) {
  final orderCode = order['orderDetails'] ["orderCode"]?? '';
  final orderDetails = order['ordersDetails'] ?? [];
  final dropAddressList = order['dropAddress'] as List<dynamic>?;
  final orderedBy = (dropAddressList != null &&
          dropAddressList.isNotEmpty &&
...
Text(
                         "Payment : ",
                            ...
                            Text(
                            order["isPaid"]==true ? "Setteled":"Pending",
                              textAlign: TextAlign.center,
                           style:    TextStyle(
      fontSize: 9.h,
      fontWeight: FontWeight.normal,
      color: order["isPaid"]==true ? Colors.green:Colors.red,
      fontFamily: 'Poppins-Regular')
                            ),
                          ],
                        ),
                ...
                const SizedBox(height: 10),
                CustomText(
                  text: 'Total : ${order["earningAmount"]}',
                  style: CustomTextStyle.mediumGreyText,
                ),
...
,
                  ...
                  Column(
                    ...
                    children: [
                      CustomText(
                        text: '${ordersController.totalcount}',
                        style: CustomTextStyle.insNum,
                      ),
                      CustomText(
                          text: 'Total Orders', style: CustomTextStyle.insText),
...
,
                    ...
                    Column(
                      ...
                      children: [
                        CustomText(
                          text: '${ordersController.totalearnings}',
                          style: CustomTextStyle.insNum,
                        ),
                        CustomText(
                            text: 'Revenue', style: CustomTextStyle.insText),
